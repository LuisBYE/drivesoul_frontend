...
export default function Footer() {
  ...
  return (
    <footer className="bg-zinc-900 text-white pt-12 pb-6 relative mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="col-span-1">
            ...
            <p className="text-gray-400 mb-6">Conduce tu pasión, vive tu alma.</p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">Calle de los Sueños, 123, Madrid, España</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-red-600 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                </svg>
                <span className="text-gray-400">contacto@drivesoul.com</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-red-600 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="border-t border-zinc-800 mt-8 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              <a href="#" className="text-gray-500 hover:text-red-500 text-sm">Política de privacidad</a>
              <a href="#" className="text-gray-500 hover:text-red-500 text-sm">Términos y condiciones</a>
